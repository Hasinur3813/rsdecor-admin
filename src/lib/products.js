...
export const CATEGORIES = [
  {
    ...
    items: [
      ...
      { label: "Kids Room", filter: { category: "3D Wallpaper", room: "Kids Room" } },
      { label: "Bedroom", filter: { category: "3D Wallpaper", room: "Bedroom" } },
      { label: "Living Room", filter: { category: "3D Wallpaper", room: "Living Room" } },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Marble Finish", filter: { category: "3D Epoxy Floor", finish: "Matte" } },
      { label: "Metallic Finish", filter: { category: "3D Epoxy Floor", finish: "Metallic" } },
    ],
  },
];

// Options for select fields
export const MATERIAL_OPTIONS = ["Fabric", "Vinyl", "Non-Woven", "Paper", "Epoxy Resin", "PVC"];
export const COLOR_FAMILY_OPTIONS = ["Warm", "Cool", "Neutral", "Bold", "Pastel"];
export const WARRANTY_OPTIONS = ["5 Years", "10 Years", "15 Years", "20 Years", "Lifetime"];
export const FINISH_OPTIONS = ["3D Embossed", "Glossy", "Matte", "Metallic", "Textured", "Smooth"];
